 ...
 ***************************************************************************/
void destroyTree(struct node *tree) { free(tree); }
 ...
 ***************************************************************************/
void insert(struct node *tree, int *root, unsigned char *window, int abs_off,
            int len, int max) {
  /* variables */
  int i, tmp;
...
struct ret find(struct node *tree, int root, unsigned char *window, int index,
  ...
  while (1) {
     ...
     */
    for (i = 0; window[index + i] == window[tree[j].off + i] && i < size - 1;
         i++) {
    }
 ...
 *                max - size of the tree array
 ***************************************************************************/
void delete(struct node *tree, int *root, unsigned char *window, int abs_sb,
            int max) {
  /* variables */
  int parent, child, sb;
